...
public class FormigaComilona : Enemigo
{
    ...
    void Update()
    {
        ...
        if (this.transform.position.x > ren.transform.position.x)
        {
            ...
            this.transform.GetChild(2).gameObject.transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>().flipX = false;
        }
        else
        {
            ...
            this.transform.GetChild(2).gameObject.transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>().flipX = true;
            this.transform.GetChild(2).gameObject.transform.GetChild(0).gameObject.transform.localPosition = new Vector2(0.50f, this.transform.GetChild(2).gameObject.transform.GetChild(0).gameObject.transform.localPosition. y);
        }
    }
    public void OnTriggerEnter2D(Collider2D other)
    {
        if (other.gameObject.tag == ("Ren"))
        {
            ...
            other.gameObject.GetComponent<Ren2D>().Hostion(5);
